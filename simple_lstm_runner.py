...
def train(model, loss_fn, optimizer, train_loader, test_loader,
    ...
    print(f" Train accuracy: {evaluate(model,loss_fn, train_loader)}. Test accuracy: {evaluate(model,loss_fn, test_loader)}") 
...
torch.save(model, "/gpfs/milgram/project/rtaylor/shared/ABDPain_EarlyDiags/models/simple_nn_v2.model")
